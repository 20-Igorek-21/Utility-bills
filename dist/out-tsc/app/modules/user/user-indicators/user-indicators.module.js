...
let UserIndicatorsModule = class UserIndicatorsModule {
};
UserIndicatorsModule = __decorate([
    NgModule({
        declarations: [
...
export { UserIndicatorsModule };
//# sourceMappingURL=user-indicators.module.js.map